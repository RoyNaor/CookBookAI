        ...
        <AnimatePresence mode="wait">
          {isSuccess ? (
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">שמחים שחזרת!</h2>
              <p className="text-gray-600">ההתחברות בוצעה בהצלחה.</p>
              <p className="text-amber-600 text-sm mt-4 animate-pulse">נכנס למטבח...</p>
            </motion.div>
